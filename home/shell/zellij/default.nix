{pkgs, ...}: {
  ...
  xdg.configFile."zellij/layouts/cohere.kdl".text = ''
        layout {
    default_tab_template {
      ...
      tab split_direction="vertical" name="Python" {
        pane {
          cwd "~/Projects/Cohere/Python"
          command "nom-shell"
          size "70%"
        }
        pane {
      ...
      tab split_direction="vertical" name="Java" {
        pane {
          cwd "~/Projects/Cohere/Java"
          command "nom-shell"
          size "70%"
        }
        pane {
      ...
      tab split_direction="vertical" name="JS" {
        pane {
          cwd "~/Projects/Cohere/JS"
          command "nom-shell"
          size "70%"
        }
        pane {
      ...
      tab split_direction="vertical" name="React" {
        pane {
          cwd "~/Projects/Cohere/React"
          command "nom-shell"
          size "70%"
        }
        pane {
